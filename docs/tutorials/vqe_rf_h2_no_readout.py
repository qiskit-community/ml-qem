...
backend = RemoveReadoutErrors(FakeLima()).remove_readout_errors()[0]
...
if __name__ == '__main__':
    ...
    if sep_ob_zne:
        with open('../paper_figures/vqe_with_zne_202407_no_readout_sep_ob_zne.pk', 'wb') as file:
            pickle.dump(to_save, file)
    else:
        with open('../paper_figures/vqe_with_zne_202407_no_readout.pk', 'wb') as file:
            pickle.dump(to_save, file)